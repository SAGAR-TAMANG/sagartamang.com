...
**🎉 Official Public Release:** F.R.I.D.A.Y. is now available as a standalone desktop application! You can download the `.exe` for Windows or `.dmg` for macOS directly at [friday.feynmanpi.com](http://friday.feynmanpi.com/).
...
- [Download App](http://friday.feynmanpi.com/)
