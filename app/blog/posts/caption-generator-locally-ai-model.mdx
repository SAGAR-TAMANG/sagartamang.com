...
<div align="center">
  ...
  <p>
    <a href="https://youtu.be/4mdRA1sbYd4" target="_blank" rel="noopener">
...
- `-i` — Input Video — e.g. `-i "/sdcard/Download/video.mp4"`
- `-o` — Output Folder — e.g. `-o "/sdcard/Download/"`
- `-m` — AI Model — e.g. `-m turbo` (Fastest/Best)
